...
export function BookSection() {
  ...
  return (
    <section id="libro" className="py-24 lg:py-32 bg-[#0a0a0a] relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-[#B59A55]/3 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative animate-float">
              ...
              <div
                ...
                style={{
                  boxShadow: "0 0 50px rgba(181, 154, 85, 0.2), 0 25px 60px rgba(0,0,0,0.6)",
                }}
              >
                <Image
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#1e1e1e] mb-8">
              ...
              <span className="text-xs font-semibold text-[#9A7B2F]">{book.publisher}</span>
            </div>
