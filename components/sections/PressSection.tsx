  ...
  return (
    <section id="prensa" className="py-16 bg-[#0a0a0a] border-y border-[#1e1e1e]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div>
            <p className="text-xs uppercase tracking-widest text-[#9A7B2F] mb-2">
              Medios y prensa
            </p>
          ...
          <div className="flex flex-wrap gap-3 shrink-0">
            <Link
              href="/prensa"
              className="px-5 py-2.5 text-sm border border-[#9A7B2F]/40 text-[#9A7B2F] rounded-lg hover:bg-[#9A7B2F]/10 transition-colors font-medium"
            >
              Kit de prensa
            </Link>
            <Link
