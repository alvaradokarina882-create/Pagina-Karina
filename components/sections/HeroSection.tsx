...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute top-1/4 right-0 w-[600px] h-[600px] rounded-full bg-[#B59A55]/4 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-0 w-[400px] h-[400px] rounded-full bg-[#796020]/6 blur-[100px] pointer-events-none" />

      {/* Decorative gold lines */}
      <div className="absolute top-20 left-10 w-px h-32 bg-gradient-to-b from-transparent via-[#9A7B2F]/30 to-transparent" />
      <div className="absolute top-40 right-10 w-px h-48 bg-gradient-to-b from-transparent via-[#9A7B2F]/20 to-transparent" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-16 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#9A7B2F]/30 bg-[#9A7B2F]/5 mb-8"
        >
        ...
        >
          <div className="flex items-center gap-2">
            <span className="text-[#B59A55] font-bold text-base">28+</span>
            <span>Años en la industria de la belleza</span>
          </div>
          <div className="hidden sm:block w-px h-4 bg-[#1e1e1e]" />
          <div className="flex items-center gap-2">
            <span className="text-[#B59A55] font-bold text-base">15+</span>
