...
export function ContactSection() {
  ...
  return (
    <section id="contacto" className="py-24 lg:py-32 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#B59A55]/3 blur-[80px] pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            {contactOptions.map((option, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[#9A7B2F]/10 border border-[#9A7B2F]/20 flex items-center justify-center text-[#9A7B2F] text-xl group-hover:bg-[#9A7B2F]/20 transition-colors shrink-0">
                  {option.icon}
                </div>
                <div className="flex-1">
                  ...
                  <div className="text-xs text-[#9A7B2F] mt-1">{option.email}</div>
                </div>
                <div className="text-[#404040] group-hover:text-[#9A7B2F] transition-colors">
                  →
                </div>
              </motion.a>
            ))}
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    className="px-3 py-1.5 text-xs border border-[#1e1e1e] text-[#606060] rounded-lg hover:border-[#9A7B2F]/40 hover:text-[#9A7B2F] transition-all"
                  >
                    {social.label}
                  </a>
                ))}
          ...
          >
            {sent ? (
              <div className="card-premium p-8 text-center h-full flex flex-col items-center justify-center">
                <div className="w-16 h-16 rounded-full bg-[#9A7B2F]/20 flex items-center justify-center text-2xl text-[#B59A55] mb-4">
                  ✓
                </div>
              ...
              <form onSubmit={handleSubmit} className="card-premium p-8 space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      required
                      className="w-full bg-[#0a0a0a] border border-[#1e1e1e] rounded-lg px-4 py-3 text-sm text-white placeholder-[#404040] focus:outline-none focus:border-[#9A7B2F]/50 transition-colors"
                ...
                <div>
                  ...
                  <select
                    name="tipo"
                    className="w-full bg-[#0a0a0a] border border-[#1e1e1e] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-[#9A7B2F]/50 transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full bg-[#0a0a0a] border border-[#1e1e1e] rounded-lg px-4 py-3 text-sm text-white placeholder-[#404040] focus:outline-none focus:border-[#9A7B2F]/50 transition-colors resize-none"
