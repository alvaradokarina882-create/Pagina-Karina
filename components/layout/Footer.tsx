        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#C6A15B] to-[#8A6817] flex items-center justify-center text-black font-bold">
                K
              </div>
            ...
            <div className="flex gap-3 flex-wrap">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-[#1e1e1e] flex items-center justify-center text-[#606060] text-xs font-bold hover:border-[#B8922E] hover:text-[#C6A15B] transition-all"
                >
                  {social.icon}
                </a>
              ))}
          ...
          {Object.entries(footerLinks).map(([section, links]) => (
            <div key={section}>
              <h3 className="text-xs font-semibold uppercase tracking-widest text-[#C6A15B] mb-4">
                {section}
              </h3>
