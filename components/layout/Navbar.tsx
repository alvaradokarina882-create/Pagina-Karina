    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#B59A55] to-[#796020] flex items-center justify-center text-black font-bold text-sm group-hover:scale-110 transition-transform">
            K
          </div>
              ...
              >
                ...
                {pathname === link.href && (
                  <motion.span
                    ...
                    className="absolute -bottom-1 left-0 right-0 h-px bg-gradient-to-r from-[#B59A55] to-[#796020]"
                  />
                )}
              </Link>
            </li>
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-base font-medium py-2 border-b border-[#1e1e1e] transition-colors ${
                    pathname === link.href ? "text-[#B59A55]" : "text-[#a8a8a8]"
                  }`}
                >
                  {link.label}
                </Link>
