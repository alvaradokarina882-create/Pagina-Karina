...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Karina Alvarado's journey from beauty professional to entrepreneur, author, and international speaker who has trained 5,000+ women across 20+ countries.",
  openGraph: {
    locale: "en_US",
