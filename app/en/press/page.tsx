      ...
      <section className="pt-32 pb-20 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center gap-2 text-xs text-[#404040] mb-8">
            ...
            <span>/</span>
            <span className="text-[#9A7B2F]">Press</span>
          </div>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-[#9A7B2F] mb-4">Short version</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-[#9A7B2F] mb-4">Key facts</h3>
