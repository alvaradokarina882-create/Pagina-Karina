      ...
      <section className="pt-32 pb-16 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center gap-2 text-xs text-[#404040] mb-8">
            ...
            <span>/</span>
            <span className="text-[#B8922E]">Blog</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="card-premium p-4 mb-8 text-center">
            <p className="text-xs text-[#606060]">
              ...
              <Link href="/blog" className="text-[#B8922E] hover:text-[#C6A15B]">
                View all articles in Spanish →
              </Link>
            </p>
          </div>

          <h2 className="text-sm font-semibold uppercase tracking-wider text-[#B8922E] mb-6">
            Featured articles
          </h2>
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {featured.map((post) => (
              ...
              >
                ...
                <h3 className="font-serif text-base font-bold text-white mb-3 group-hover:text-[#C6A15B] transition-colors">
                  {post.title}
                </h3>
                <p className="text-sm text-[#606060] leading-relaxed mb-4 line-clamp-2">
                  {post.excerpt}
                </p>
                <div className="text-xs text-[#B8922E] group-hover:translate-x-1 transition-transform inline-block">
                  Read (ES) →
                </div>
              </Link>
            ))}
          ...
          <div className="space-y-3">
            {rest.map((post) => (
              ...
              >
                <div>
                  <div className="text-xs text-[#B8922E] mb-1">{post.category}</div>
                  <h3 className="text-sm font-semibold text-white group-hover:text-[#C6A15B] transition-colors">
                    {post.title}
                  </h3>
                </div>
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <span className="text-xs text-[#B8922E] group-hover:translate-x-1 transition-transform">→</span>
                </div>
              </Link>
            ))}
          </div>
