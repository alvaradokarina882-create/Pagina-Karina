    ...
    <section className="pt-32 pb-20 bg-[#050505]">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        <div className="flex items-center gap-2 text-xs text-[#404040] mb-8">
          ...
          <span>/</span>
          <span className="text-[#B8922E]">Privacy Policy</span>
        </div>
        ...
        <div className="space-y-10 text-[#a8a8a8] text-sm leading-relaxed">
          ...
          <div>
            ...
            <p>
              ...
              <a href={`mailto:${personal.contact.emailEn}`} className="text-[#B8922E]">{personal.contact.emailEn}</a>.
            </p>
          </div>
          ...
          <p className="text-xs text-[#404040]">
            ...
            <a href={`mailto:${personal.contact.emailEn}`} className="text-[#B8922E]">{personal.contact.emailEn}</a>
            {" "}·{" "}
            <Link href="/en/terms" className="text-[#B8922E]">Terms of Use</Link>
            {" "}·{" "}
            <Link href="/privacidad" className="text-[#B8922E]">Versión en español</Link>
          </p>
        </div>
      </div>
    </section>
