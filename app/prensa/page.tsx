      ...
      <section className="py-20 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.title} className="card-premium p-4 flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-[#A98224]/10 border border-[#A98224]/20 flex items-center justify-center text-xs font-bold text-[#A98224] shrink-0">
          ...
          <p className="text-sm text-[#404040] mt-6">
            ...
            <a href={`mailto:${personal.contact.press}`} className="text-[#A98224]">
