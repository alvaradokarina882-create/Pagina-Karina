    ...
    <section className="pt-32 pb-20 bg-[#050505]">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        <div className="flex items-center gap-2 text-xs text-[#404040] mb-8">
          ...
          <span>/</span>
          <span className="text-[#9A7B2F]">Términos de uso</span>
        </div>
        ...
        <div className="space-y-10 text-[#a8a8a8] text-sm leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              <a href={`mailto:${personal.contact.email}`} className="text-[#9A7B2F]">{personal.contact.email}</a>.
            </p>
          </div>
          ...
          <p className="text-xs text-[#404040]">
            <Link href="/privacidad" className="text-[#9A7B2F]">Política de Privacidad</Link>
            {" "}·{" "}
            <Link href="/en/terms" className="text-[#9A7B2F]">English version</Link>
          </p>
        </div>
      </div>
    </section>
