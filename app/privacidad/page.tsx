    ...
    <section className="pt-32 pb-20 bg-[#050505]">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        <div className="flex items-center gap-2 text-xs text-[#404040] mb-8">
          ...
          <span>/</span>
          <span className="text-[#A98224]">Privacidad</span>
        </div>
        ...
        <div className="space-y-10 text-[#a8a8a8] text-sm leading-relaxed">
          ...
          <p className="text-xs text-[#404040]">
            ...
            <a href={`mailto:${personal.contact.email}`} className="text-[#A98224]">{personal.contact.email}</a>
            {" "}·{" "}
            <Link href="/terminos" className="text-[#A98224]">Términos de uso</Link>
            {" "}·{" "}
            <Link href="/en/privacy" className="text-[#A98224]">English version</Link>
          </p>
        </div>
      </div>
    </section>
