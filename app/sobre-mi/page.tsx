  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 bg-[#050505] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#C6A15B]/3 blur-[100px] pointer-events-none" />
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#B8922E]/30 bg-[#B8922E]/5 mb-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {personal.filosofia.map((item) => (
                  <div key={item.title} className="card-premium p-4">
                    <div className="text-[#B8922E] text-xl mb-2">{item.icon}</div>
      ...
      <section className="py-20 bg-[#050505]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-4 lg:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#B8922E]/50 via-[#B8922E]/20 to-transparent" />
                ...
                >
                  ...
                  <div className="flex-1 pl-12 lg:pl-0">
                    <div className="card-premium p-5">
                      <div className="text-[#B8922E] font-bold text-sm mb-2">{item.year}</div>
                  ...
                  <div className="absolute left-4 lg:static lg:flex-none flex items-center">
                    <div className="w-3 h-3 rounded-full bg-[#C6A15B] border-2 border-[#0a0a0a] -ml-1.5 lg:ml-0" />
                  </div>
