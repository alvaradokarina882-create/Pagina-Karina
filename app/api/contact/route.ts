    ...
    const { error } = await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#0a0a0a;color:#e5e5e5;border-radius:8px;">
          <div style="border-bottom:2px solid #B8922E;padding-bottom:16px;margin-bottom:24px;">
            <h2 style="color:#C6A15B;margin:0;font-size:20px;">Nuevo mensaje desde soykarinaalvarado.com</h2>
          </div>
          <table style="width:100%;border-collapse:collapse;">
            ...
            <tr><td style="padding:8px 0;color:#a8a8a8;">Email</td><td style="padding:8px 0;"><a href="mailto:${email}" style="color:#C6A15B;">${email}</a></td></tr>
            <tr><td style="padding:8px 0;color:#a8a8a8;">Tipo</td><td style="padding:8px 0;color:#fff;">${tipo || "No especificado"}</td></tr>
          </table>
          <div style="margin-top:24px;padding:16px;background:#141414;border-left:3px solid #B8922E;border-radius:4px;">
