  ...
  return (
    <>
      ...
      <section className="py-6 bg-[#0a0a0a] border-b border-[#1e1e1e] sticky top-16 lg:top-20 z-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex gap-3 overflow-x-auto pb-1 no-scrollbar">
            <button className="shrink-0 px-4 py-1.5 rounded-full bg-[#B8922E]/10 border border-[#B8922E]/30 text-xs font-medium text-[#B8922E]">
              Todos
            </button>
            {categories.map((cat) => (
              <button
                key={cat}
                className="shrink-0 px-4 py-1.5 rounded-full border border-[#1e1e1e] text-xs text-[#606060] hover:border-[#B8922E]/30 hover:text-[#a8a8a8] transition-colors"
              >
                {cat}
              </button>
            ))}
      ...
      <section className="py-16 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-[#B8922E] mb-8">
            Destacados
          </h2>
            ...
            {featured.map((post) => (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xs font-medium text-[#B8922E] border border-[#B8922E]/30 px-2 py-0.5 rounded-full">
                    {post.category}
                  </span>
                  <span className="text-xs text-[#404040]">{post.readTime} min</span>
                </div>
                <h3 className="font-serif text-lg font-bold text-white mb-3 leading-snug flex-1 group-hover:text-[#C6A15B] transition-colors">
                  {post.title}
                </h3>
                ...
                <div className="pt-4 border-t border-[#1e1e1e] flex items-center justify-between">
                  ...
                  <span className="text-xs text-[#B8922E] group-hover:translate-x-1 transition-transform inline-block">
                    Leer →
                  </span>
                </div>
              </Link>
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs text-[#B8922E]">{post.category}</span>
                    <span className="text-[#1e1e1e]">·</span>
                    <span className="text-xs text-[#404040]">{post.readTime} min de lectura</span>
                  </div>
                  <h3 className="font-semibold text-white mb-1 group-hover:text-[#C6A15B] transition-colors text-sm lg:text-base">
                    {post.title}
                  </h3>
                ...
                <div className="shrink-0 flex flex-col items-end gap-2">
                  ...
                  <span className="text-xs text-[#B8922E] group-hover:translate-x-1 transition-transform">
                    →
                  </span>
                </div>
              </Link>
      ...
      <section className="py-20 bg-[#050505]">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <div className="card-premium p-8">
            <div className="text-3xl text-[#B8922E] mb-4">✦</div>
